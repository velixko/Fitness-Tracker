...
import MPT_pushup_webcam
import MPT_squat_webcam  
import MPT_situp_webcam
...
exercise_info = {
    'Push-ups': {
        ...
        'video_path': r"C:\Users\velix\MyFitnessTracker\pushup.mp4",  #Local File
        'tutorial': [
        ...
        'instruction_video_path': r"C:\Users\velix\MyFitnessTracker\pushup.mp4"  
    },
    'Sit-ups': {
        'description': 'Sit-ups are a core strengthening exercise that target the abdominal muscles.',
        'video_path': r"C:\Users\velix\MyFitnessTracker\situp.mp4",  #Local File
        'tutorial': [
        ...
        'instruction_video_path': r"C:\Users\velix\MyFitnessTracker\situp.mp4" 
    },
    'Squats': {
        'description': 'Squats are a lower body exercise that target the quadriceps, hamstrings, and glutes.',
        'video_path': r"C:\Users\velix\MyFitnessTracker\squat.mp4",  #Local File
        'tutorial': [
        ...
        'instruction_video_path': r"C:\Users\velix\MyFitnessTracker\squat.mp4"
    }
}
...
if selected_exercise == 'Push-ups' and live_or_video == 'Webcam':
   ...
   if st.button('Start Push-ups'):
        subprocess.run(['python', r"C:\Users\velix\MyFitnessTracker\MPT_push-up_webcam.py"])
...
if selected_exercise == 'Squats' and live_or_video == 'Webcam':
   ...
   if st.button('Start Squats'):
        subprocess.run(['python', r"C:\Users\velix\MyFitnessTracker\MPT_squat_webcam.py"])
...
if selected_exercise == 'Sit-ups' and live_or_video == 'Webcam':
   ...
   if st.button('Start Sit-ups'):
        subprocess.run(['python', r"C:\Users\velix\MyFitnessTracker\MPT_situp_webcam.py"])
